...
function RecipeEditForm() {
    ...
    try {
      ...
      if (recipe.ingredients && recipe.ingredients.length > 0) {
        setRecipeIngredients(recipe.ingredients.map((ing: any) => ({
          ...
          unit: ing.unit,
          wastagePercent: ing.wastagePercent?.toString() || '0',
          notes: ing.notes || '',
        })));
      }
    } catch (error: any) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await api.recipes.update(recipeId, payload);
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-gray-600 mt-1">Update the Bill of Materials for this composite item</p>
        </div>
      </div>
